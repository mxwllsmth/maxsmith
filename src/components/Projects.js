    ...
    <div>
      ...
      <div id="potholeContainer">
        ...
        <div id="pothole">
          ...
          <p>This applicaton was completed using the following technologies: </p>
          <p id="skills">PostgreSQL&nbsp;&nbsp;|&nbsp;&nbsp;Java&nbsp;&nbsp;|&nbsp;&nbsp;Vue.js&nbsp;&nbsp;|&nbsp;&nbsp;JavaScript&nbsp;&nbsp;|&nbsp;&nbsp;HTML&nbsp;&nbsp;|&nbsp;&nbsp;CSS&nbsp;&nbsp;|
            &nbsp;&nbsp;IntelliJ&nbsp;&nbsp;|&nbsp;&nbsp;VS Code&nbsp;&nbsp;|&nbsp;&nbsp;MapBox - third party API&nbsp;&nbsp;|&nbsp;&nbsp;Postman&nbsp;&nbsp;|&nbsp;&nbsp;pgAdmin 4</p>
          <p>The goal of this project was to create a utility application for the city of Philadelphia to manage their potholes. Any person can create an account and </p>
          <p>report a pothole, any person with or without an account can view reported potholes and track their repair status, and an employee/ Admin user can</p>
          <p>update potholes to input severity and date inspected and/or repaired, and delete potholes when neccesary.</p>
          <p></p>
          <p>This project was completed with a ten-day time restriction and our team took an Agile approach to split the project into managable sections of work.</p>
          <p>My teams code for this project includes a RESTful API server, a front end client in Vue.js, a normalized database, and a third-party API from MapBox.</p>
        </div>
      </div>
      <div id="tenmoContainer">
        <div id="tenmo">
          ...
          <p>The goal of this project was to mimic the functionality of venmo by creating a service where a user can request or send money, their transaction will be</p>
          <p>recorded in a database, and their account balances will be updated accordingly.</p>
          <p></p>
          <p>This project was completed with a five-day time restriction in a team of two.</p>
      ...
      <div id="vendingContainer">
        ...
        <div id="vending">
          ...
          <p>The goal of this project was to make a fully functional virtual vending machine that behaves just like a real one. The vending machine needed to be </p>
          <p>able to take money and track the users balance, verify purchases for inventory and balance, give change in number of each coin type, and log all </p>
          <p>transactions and events.</p>
          <p></p>
          <p>This project was completed with a four-day time restriction in a team of two.</p>
        </div>
      </div>
    </div>
  );
